...
Item {
    ...
    Text {
        ...
        text: "The histogram is an OpenGL scene rendered to a texture via an FBO,"
            + "rendered on the scene graph rendering thread. It is then displayed "
            + "as a custom item using a QSGSimpleTextureNode."
    }
}
