...
AntiAliasingScene::AntiAliasingScene( QObject* parent )
    : CameraScene( parent ),
      m_obj( 0 ),
      m_theta( 0.0f ),
      m_rotate( false ),
...
void AntiAliasingScene::initialise()
{
    // Create a material that performs multi-texturing
    MaterialPtr material( new Material );
    material->setShaders( ":/shaders/antialiasing.vert",
...
void AntiAliasingScene::update( float t )
{
