#ifndef EDGEDETECTIONSCENE_H
#define EDGEDETECTIONSCENE_H
...
class EdgeDetectionScene : public AbstractScene
{
    Q_OBJECT

public:
    EdgeDetectionScene( const QString& fileName, QObject* parent = 0 );
