...
const int samples = 5;
uniform float pixelOffset[samples] = float[]( 0.0, 1.0, 2.0, 3.0, 4.0 );
uniform float weight[samples] = float[]( 0.2270270270,
                                         0.1945945946,
                                         0.1216216216,
                                         0.0540540541,
                                         0.0162162162 );
...
const int samples = 3;
uniform float pixelOffset[samples] = float[]( 0.0, 1.3846153846, 3.2307692308 );
uniform float weight[samples] = float[]( 0.2270270270,
                                         0.3162162162,
                                         0.0702702703 );
*/
