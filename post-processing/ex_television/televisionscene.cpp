...
TelevisionScene::TelevisionScene( const QString& fileName, QObject* parent )
...
void TelevisionScene::initialise()
{
    ...
    MaterialPtr postProcessMaterial = createPostProcessMaterial( ":/shaders/television.vert",
...
void TelevisionScene::update( float t )
{
    // Store the time to pass into the post-processing shader
    m_time = t;
...
void TelevisionScene::switchToFBO()
{
    // Bind the FBO
    m_funcs->glBindFramebuffer( GL_FRAMEBUFFER, m_fbo );
}

void TelevisionScene::switchToDefaultFramebuffer()
{
    // Bind the default frame buffer
    m_funcs->glBindFramebuffer( GL_FRAMEBUFFER, 0 );
}

void TelevisionScene::renderScene()
{
...
void TelevisionScene::postProcessScene()
{
...
void TelevisionScene::resize( int w, int h )
{
...
void TelevisionScene::prepareFBO( GLuint textureId )
{
    // TODO Create a FrameBuffer class
...
MaterialPtr TelevisionScene::createPostProcessMaterial( const QString& vertexShader,
