...
ToonScene::ToonScene( const QString& fileName )
    : m_fileName( fileName ),
      m_modelMatrix(),
      m_viewMatrix(),
      m_projectionMatrix(),
...
void ToonScene::initialise()
{
    ...
    material->setShaders( ":/shaders/toon.vert",
                          ":/shaders/toon.frag" );
...
void ToonScene::render()
{
    ...
    QVector3D eye( 1.0f, 0.6f, 0.3f );
    QVector3D center( 0.0f, -0.2f, 0.0f );
    ...
    shader->setUniformValue( "material.kd", QVector3D( 0.0f, 0.7f, 0.0f ) );
